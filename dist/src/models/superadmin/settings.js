...
exports.settings = (0, mysql_core_1.mysqlTable)("settings", {
    ...
    rejected_online_deduction: (0, mysql_core_1.int)("rejected_online_deduction").default(0),
    rejected_holiday_deduction: (0, mysql_core_1.int)("rejected_holiday_deduction").default(0),
    online_without_permission_deduction: (0, mysql_core_1.int)("online_without_permission_deduction").default(0),
    holiday_without_permission_deduction: (0, mysql_core_1.int)("holiday_without_permission_deduction").default(0),
    delay_per_hour_deduction: (0, mysql_core_1.int)("delay_per_hour_deduction").default(0),
